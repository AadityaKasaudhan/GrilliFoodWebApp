    ...
    <article>
      ...
      <section class="section about text-center" aria-labelledby="about-label" id="about">
        <div class="container">
          ...
          <div class="about-content">
            ...
            <a href="tel:+804001234567" class="body-1 contact-number hover-underline">+91 9559812026</a>
      ...
      <section class="section testi text-center has-bg-image"
        ...
        <div class="container">
          ...
          <div class="profile">
            <img src="./assets/images/1a.jpg" width="100" height="100" loading="lazy" alt="Sam Jhonson"
              class="img">

            <p class="label-2 profile-name">Aditya Kasaudhan</p>
          </div>
          ...
          <div class="form reservation-form bg-black-10">
            ...
            <form action="" class="form-left">
              ...
              <p class="form-text text-center">
                Booking request <a href="tel:+88123123456" class="link">+91 9559812026</a>
            ...
            <div class="form-right text-center" style="background-image: url('./assets/images/form-pattern.png')">
              ...
              <a href="tel:+88123123456" class="body-1 contact-number hover-underline">+91 9559812026</a>
